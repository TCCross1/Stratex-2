...
"""
from fastapi import HTTPException, Depends, Request, WebSocket, WebSocketDisconnect, Query
...
from core import (
    app, api, auth_r, client, db, get_db, logger, now_iso,
    current_user, contractor_only, operator_only, admin_only, contractor_ndaed,
    _public_user, _strip_pricing,
)
...
async def on_startup():
    ...
    await db.jobs.update_one(
        ...
        {"$set": {
            ...
            "contractor_license": "LIC-KY-99214X",
            "professional_name": "Tony Cross",
            "geometrics_extended": {
                "total_squares_net": 16.21,
                "valley_linear_feet": 148.66,
                "rake_gable_linear_feet": 192.33,
                "net_wall_siding_area_sqft": 2450.00,
            },
            "moisture_diagnostics": [
                {
                    "grid_id": "Grid B2-RED-H1",
                    "location": "High Dormer Corner",
                    "concern_code": "CODE A14-RED-V1",
                    "severity": "CRITICAL",
                    "probability_pct": 78,
                    "notes": "Trapped moisture detected. High risk of CDX deck rot and structural framing decay.",
                },
                {
                    "grid_id": "Grid C4-1 & C4-2",
                    "location": "Multiple Valley Junction",
                    "concern_code": "CODE C33-YELLOW-V3",
                    "severity": "MILD",
                    "probability_pct": 65,
                    "notes": "Elevated moisture detected near transition runs. Monitor closely.",
                },
            ],
            "financial_phases": {
                "framing":  {"estimated_man_hours": 180, "total_price_usd": 61714.00,
                             "scope": "Structural framing repair, dormer corner reconstruction, sub-deck reinforcement"},
                "roofing":  {"estimated_man_hours": 285, "total_price_usd": 96170.00,
                             "scope": "Finished slate replacement, valley re-detail, ridge & hip cap, I&WS underlayment"},
                "gutters":  {"estimated_man_hours": 55,  "total_price_usd": 22538.00,
                             "scope": "Half-round copper gutter replacement, downspouts, internal box gutter relining"},
                "siding":   {"estimated_man_hours": 120, "total_price_usd": 48734.00,
                             "scope": "James Hardie fiber-cement plank, factory-finished, color-matched to historic palette"},
            },
            "disposal_logistics": {
                "dumpster_flat_fee_usd": 1800.00,
                "overall_total_project_value_usd": 203080.00,
                "total_combined_man_hours": 640,
            },
